...
"nav.codexAuth": "Codex 認証",
  "nav.codexSet": "Codex 設定",
    "codexSet.tab.webquota": "Web クォータ",
  "codexSet.webquota.loading": "Web クォータを読み込み中...",
  "codexSet.webquota.empty": "Web クォータ統合がアクティブでないか、観測データがありません。",
  "codexSet.webquota.title": "Web クォータモニター",
  "codexSet.webquota.active": "アクティブ",
  "codexSet.webquota.observedUsage": "観測された使用量",
  "codexSet.webquota.resetWindow": "リセットウィンドウ",
  "codexSet.webquota.totalWindow": "合計ウィンドウ",
  "codexSet.webquota.windowConsumption": "ウィンドウ消費率",
