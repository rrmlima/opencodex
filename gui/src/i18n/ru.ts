...
"nav.codexAuth": "Аутентификация Codex",
  "nav.codexSet": "Настройки Codex",
    "codexSet.tab.webquota": "Веб-квота",
  "codexSet.webquota.loading": "Загрузка веб-квоты...",
  "codexSet.webquota.empty": "Интеграция веб-квоты не активна или нет наблюдаемых данных.",
  "codexSet.webquota.title": "Монитор веб-квоты",
  "codexSet.webquota.active": "Активно",
  "codexSet.webquota.observedUsage": "Использование",
  "codexSet.webquota.resetWindow": "Окно сброса",
  "codexSet.webquota.totalWindow": "Всего окно",
  "codexSet.webquota.windowConsumption": "Расход окна",
