...
"nav.codexAuth": "Codex 认证",
  "nav.codexSet": "Codex 设置",
    "codexSet.tab.webquota": "网页配额",
  "codexSet.webquota.loading": "正在加载网页配额...",
  "codexSet.webquota.empty": "网页配额集成未激活或尚无观察到的数据。",
  "codexSet.webquota.title": "网页配额监控",
  "codexSet.webquota.active": "活跃",
  "codexSet.webquota.observedUsage": "观察到的用量",
  "codexSet.webquota.resetWindow": "重置窗口",
  "codexSet.webquota.totalWindow": "总窗口",
  "codexSet.webquota.windowConsumption": "窗口消耗",
