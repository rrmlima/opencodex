...
"nav.codexAuth": "Codex 인증",
  "nav.codexSet": "Codex 설정",
    "codexSet.tab.webquota": "웹 쿼터",
  "codexSet.webquota.loading": "웹 쿼터 로드 중...",
  "codexSet.webquota.empty": "웹 쿼터 연동이 활성화되지 않았거나 관측된 지표가 없습니다.",
  "codexSet.webquota.title": "웹 쿼터 모니터",
  "codexSet.webquota.active": "활성",
  "codexSet.webquota.observedUsage": "관측된 사용량",
  "codexSet.webquota.resetWindow": "재설정 주기",
  "codexSet.webquota.totalWindow": "전체 주기",
  "codexSet.webquota.windowConsumption": "주기 소진율",
